...
project1.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/film.jpg")), filename: 'film-can.jpg')
project2 = Project.find(2)
project2.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/comix.jpg")), filename: 'comix.jpg')
project3 = Project.find(3)
project3.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/drono.jpg")), filename: 'drono.jpg')
project4 = Project.find(4)
project4.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/dominos.jpg")), filename: 'dominos.jpg')
project5 = Project.find(5)
project5.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/swagger.jpg")), filename: 'swagger.jpg')
project6 = Project.find(6)
project6.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/micro.jpg")), filename: 'micro.jpg')
project7 = Project.find(7)
project7.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/green.jpg")), filename: 'green.jpg')
project8 = Project.find(8)
project8.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/gingerbread.jpg")), filename: 'gingerbread.jpg')
project9 = Project.find(9)
project9.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/peppermint.jpg")), filename: 'peppermint.jpg')
project10 = Project.find(10)
project10.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/abstract.jpg")), filename: 'abstract.jpg')
project11 = Project.find(11)
project11.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/mousy.jpg")), filename: 'mousy.jpg')
project12 = Project.find(12)
project12.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/boats.jpg")), filename: 'boats.jpg')
project13 = Project.find(13)
project13.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/trouve.jpg")), filename: 'trouve.jpg')
project14 = Project.find(14)
project14.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/cube.jpg")), filename: 'cube.jpg')
project15 = Project.find(15)
project15.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/stationplay.jpg")), filename: 'stationplay.jpg')
project16 = Project.find(16)
project16.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/scramble.jpg")), filename: 'scramble.jpg')
project17 = Project.find(17)
project17.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/tyrnanny.jpg")), filename: 'tyrnanny.jpg')
project18 = Project.find(18)
project18.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/pickles.jpg")), filename: 'pickles.jpg')
project19 = Project.find(19)
project19.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/lawn-bowling.jpg")), filename: 'lawn-bowling.jpg')
project20 = Project.find(20)
project20.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/skyfall.jpg")), filename: 'skyfall.jpg')
project21 = Project.find(21)
project21.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/drifting.jpg")), filename: 'drifting.jpg')
project22 = Project.find(22)
project22.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/honeycomb.jpg")), filename: 'honeycomb.jpg')
project23 = Project.find(23)
project23.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/making-toys.jpg")), filename: 'making-toys.jpg')
project24 = Project.find(24)
project24.photo.attach(io: File.open(File.join(Rails.root, "app/assets/images/project-images/guitar.jpg")), filename: 'guitar.jpg')
