...
projects = Project.create([
	{project_name: "Film Canister: Wall Art from the Lost Age of Film", creator_id: 1 , description: "Have you ever wondered what a whole wall mural of film canisters would look like? Well ponder no longer as we embrace the lost artform of wall art embracing the lost use of mosaic film canisters", category: "Arts", current_funding: 27, goal_amount: 400, deadline: "Feburary, 1, 2023"},
	{project_name: "Comix for Kids", creator_id: 2, description: "Welcome to a new world of comics made with kids in mind. Designed to help inspire the love of reading through the medium of comics, Comix can help grow your childs love of reading while fostering creativty and community.", category: "Comics & Illustration", current_funding: 847 , goal_amount: 2000 , deadline: "June, 25th, 2022"},
